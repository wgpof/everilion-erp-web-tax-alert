...
DayPilot.Modal = function() {
    ...
    this.titleHeight = 20;
    this.titleBackgroundColor = "#d0c9c1";
    this.titleFontWeight = "bold";
    this.titleFontFamily = "Verdana";
    this.titleFontSize = 12;
    this.titleCursor = "move";
    this.title = "Modal Pop-up";
    this.titleBorder = 0;       
    
    this.totalHeight = this.height + this.titleHeight - 10;
    ...
    this.maskIframe = function() {
	    ...
	    mask.style.height = this.totalHeight + "px";
    ...
    this.create = function() {
	    ...
	    divTitle.id = this.id + 'modalTitle';
	    divTitle.style.border = this.titleBorder + "px";
	    divTitle.style.width = this.width + "px";
	    divTitle.style.height = this.titleHeight + "px";	    	    
	    divTitle.style.fontWeight = this.titleFontWeight;
	    divTitle.style.backgroundColor = this.titleBackgroundColor;
	    divTitle.style.fontFamily = this.titleFontFamily;
	    divTitle.style.cursor = this.titleCursor;
	    divTitle.style.fontSize = this.titleFontSize + "px";
